...
def findtextbox() -> None:
    ...
    location = locateOnScreen(os.path.join(dir_path, "data",  "pywhatkit_smile1.png"))
    try:
        moveTo(location[0] + 150, location[1] + 5)
        click()
    except Exception:
        try:
            location = locateOnScreen(os.path.join(dir_path, "data",  "pywhatkit_smile.png"))
            moveTo(location[0] + 150, location[1] + 5)
            click()
...
def find_link():
    dir_path = os.path.dirname(os.path.realpath(__file__))
    location = locateOnScreen(os.path.join(dir_path, "data",  "link.png"))
    print(location)
    try:
        moveTo(location[0] + location[2]/2, location[1] + location[3]/2)
        click()
    except Exception:
        location = locateOnScreen(os.path.join(dir_path, "data",  "link2.png"))
        moveTo(location[0] + location[2]/2, location[1] + location[3]/2)
        print(location)
        click()
def find_document():
    dir_path = os.path.dirname(os.path.realpath(__file__))
    location = locateOnScreen(os.path.join(dir_path, "data",  "document.png"))
    print(location)
    moveTo(location[0] + location[2]/2, location[1] + location[3]/2)
    click()
...
def find_photo_or_video():
    dir_path = os.path.dirname(os.path.realpath(__file__))
    location = locateOnScreen(os.path.join(dir_path, "data",  "photo_or_video.png"))
    print(location)
    moveTo(location[0] + location[2]/2, location[1] + location[3]/2)
    click()
